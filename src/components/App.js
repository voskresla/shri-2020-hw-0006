  ...
  return (
    <LayoutContainer className={{ hero: true, size: "s", align: "center" }}>
      <div className="grid grid_m-columns_12 grid_col-gap_full grid grid_s-columns_4">
        <div
          className="grid__fraction grid__fraction_m-col_4
            grid__fraction_s-col_4 grid__fraction_m-offset_4"
        >
          <div className="naming-problem">
            <div className="naming-problem__logo">
              <svg
                width="124"
                height="124"
                viewBox="0 0 124 124"
            ...
            <div className="naming-problem__message">
              <div className="text text_size_13_16 text_center">
                Configure repository connection and synchronization settings
              </div>
            </div>
            <div className="naming-problem__controls">
              <Button
