...
import { cn, history } from "../utils/index";
      ...
      <div className="card card_summary" onClick={this.handleCardClick}>
        ...
        <div class="card__content">
          <div class="card__history list">
            ...
            <div class="list__item meta meta_m-distribute_vertical">
              <div class="meta__item">
                <div class="icon-content">
                  <div
                    class="icon-content__icon icon-content__icon_size_m
                          icon-content__icon_indent-r_4 "
                  >
                    <div class="icon text text_view_semi-ghost">
                      <svg
                        width="16"
                        height="8"
                        viewBox="0 0 16 8"
                  ...
                  <div class="icon-content__content text text_size_13_16">
                    {card.branchName.toString().slice(0, 4)}
                    <a class="text text_view_ghost">
                      {card.commitHash.slice(0, 6)}
                    </a>
                  </div>
                </div>
              </div>
              <div class="meta__item meta__item_indent-b_8">
                <div class="icon-content">
                  <div
                    class="icon-content__icon icon-content__icon_size_m
                          icon-content__icon_indent-r_4"
          ...
          <div
            class="card__meta card__meta_m-hr_top meta
                  meta_distribute_vertical meta_m-distribute_horizontal text
                  text_size_13_16 text_view_ghost"
          >
            <div class="meta__item meta__item_indent-b_8 ">
              <div class="icon-content">
                <div
                ...
                <div class="icon-content__content ">
                  {card.start
                    ? format(new Date(card.start), "d MMM, HH:mm", {
                        locale: ru
                      })
                    : "в очереди"}
                </div>
            ...
            <div class="meta__item meta__item_indent-b_8">
              <div class="icon-content">
                ...
                <div class="icon-content__content">
                  <div class="text text_size_13_16 text_view_ghost">
                    {card.duration
                      ? formatDistanceStrict(
                          new Date(card.start),
